...
namespace BibliotecaEstudiante.Controllers
{
    class BusquedaController
    {
        ...
        public List<Temario> buscarTemaPersonalizado(string qryTema, Categoria cat)
        {
            ...
            string query =
                "Select idTema, Busqueda.idLibro, NombreTema, Descripcion, pagInicial, pagFinal from Busqueda inner join Libros" +
                "on Libros.idCategoria =" + cat.idCategoria +
                " where Busqueda match '"+qryTema+"'";
